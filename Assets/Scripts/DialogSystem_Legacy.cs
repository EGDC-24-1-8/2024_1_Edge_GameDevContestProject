...
public class DialogSystem_Legacy : MonoBehaviour
{
    private static DialogSystem_Legacy instance;
    public static DialogSystem_Legacy Instance { get { return instance; } }
